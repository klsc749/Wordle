...
public class KeyboardPanel extends JPanel {
    public static final int KEYBOARD_WIDTH = Gameconfiguration.WORDLE_WINDOW_WIDTH * 5 / 6;
    public static final int KEYBOARD_HEIGHT = Gameconfiguration.WORDLE_WINDOW_HEIGHT / 9; 
    private JPanel[] keys;
